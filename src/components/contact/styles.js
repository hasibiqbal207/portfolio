...
export const ContactButton = styled.input`
  ...
  text-align: center;
    ...
    background: linear-gradient(225deg, hsla(180, 80%, 40%, 1) 0%, hsla(210, 80%, 40%, 1) 100%);

    /* For Firefox */
    background: -moz-linear-gradient(225deg, hsla(180, 80%, 40%, 1) 0%, hsla(210, 80%, 40%, 1) 100%);
